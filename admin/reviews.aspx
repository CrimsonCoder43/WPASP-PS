<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="reviews.aspx.cs" Inherits="Sajt.admin.reviews" %>
    ...
    <table style="width:100%;">
        <tr>
            <td style="width: 420px">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BazaVeza %>" DeleteCommand="DELETE FROM [reviews] WHERE [Id] = @Id" InsertCommand="INSERT INTO [reviews] ([name], [review]) VALUES (@name, @review)" SelectCommand="SELECT * FROM [reviews]" UpdateCommand="UPDATE [reviews] SET [name] = @name, [review] = @review WHERE [Id] = @Id">
                    <DeleteParameters>
        ...
        <tr>
            <td style="width: 420px">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="Id" DataSourceID="SqlDataSource1" Height="250px" Width="420px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                    <Columns>
            ...
            <td style="width: 420px">
                <asp:Panel ID="Panel1" runat="server" Height="250px">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:BazaVeza %>" DeleteCommand="DELETE FROM [reviews] WHERE [Id] = @Id" InsertCommand="INSERT INTO [reviews] ([name], [review]) VALUES (@name, @review)" SelectCommand="SELECT * FROM [reviews] WHERE ([Id] = @Id)" UpdateCommand="UPDATE [reviews] SET [name] = @name, [review] = @review WHERE [Id] = @Id">
                        <DeleteParameters>
                            <asp:Parameter Name="Id" Type="Int32" />
                        </DeleteParameters>
                        <InsertParameters>
